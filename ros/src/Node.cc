...
Node::Node (ORB_SLAM2::System::eSensor sensor, ros::NodeHandle &node_handle, image_transport::ImageTransport &image_transport) {
  ...
  service_server_ = node_handle_.advertiseService(name_of_node_+"/save_keyframes", &Node::SaveKeyFrames, this);
...
bool Node::SaveKeyFrames (orb_slam2_ros::SaveKeyFrames::Request &req, orb_slam2_ros::SaveKeyFrames::Response &res) {
  // Stop all threads
  orb_slam_->Shutdown();
